...
IQE_CJI_TIMEOUT="30m"
COMPONENTS_W_RESOURCES="content-sources-pulp"
...
EXTRA_DEPLOY_ARGS="--set-parameter content-sources-pulp/PULP_API_MEMORY_LIMIT=2048Mi --set-parameter content-sources-pulp/PULP_API_MEMORY_REQUEST=1024Mi provisioning sources image-builder-crc"
